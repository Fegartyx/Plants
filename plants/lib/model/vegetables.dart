...
var vegetableLists = [
  Vegetables(
    ...
    detail:
        ...
        'all of which are domesticated forms of the wild carrot, native to Europe and Southwestern Asia.',
  ...
  Vegetables(
    ...
    category: 'Plant',
    detail:
        'Cabbage, is a leafy green, red (purple), or white (pale green) biennial plant.'
        'Cabbage was most likely domesticated somewhere in Europe in Ancient history before 1000 BC. '
        'Starting in the Early Modern Era, cabbage was exported to the Americas, Asia, and around the world.',
  ...
  Vegetables(
    ...
    category: 'Fruit',
    detail:
        'Eggplant (US, Canada, Australia), aubergine (UK, Ireland) or brinjal (Indian subcontinent, Singapore, Malaysia, South Africa) '
        'is a plant species in the nightshade family Solanaceae. Solanum melongena is grown worldwide for its edible fruit. ',
  ...
  Vegetables(
    ...
    detail:
        ...
        'It is classified as a member of the flowering plant family Lauraceae. The fruit of the plant, also called an avocado (or avocado pear or alligator pear), '
  ...
  Vegetables(
    ...
    detail:
        ...
        'It bears edible juicy fruits with various characteristics, most called peaches and others (the glossy-skinned, non-fuzzy varieties), nectarines. ',
