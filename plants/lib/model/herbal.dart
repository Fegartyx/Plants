...
var listHerbal = [
  Herbal(
      ...
      detail:
          ...
          'It is native to the Old World and is found in Cape Verde and the Canary Islands, and from Europe across to northern and eastern Africa, '
          'the Mediterranean, southwest Asia to India.',
  ...
  Herbal(
      name: 'Calendula',
      category: 'Herbal',
      detail: 'Calendula officinalis,'
          'is a flowering plant in the daisy family Asteraceae. It is probably native to southern Europe, '
          'though its long history of cultivation makes its precise origin unknown, and it may possibly be of '
          'garden origin. It is also widely naturalised farther north in Europe (as far as southern England) and elsewhere in warm temperate regions of the world.',
      imageAsset: 'assets/herbal/calendula_banner.jpg',
      imageUrl: [
  ...
  Herbal(
      ...
      category: 'Herbal',
      detail:
          'Basil (Ocimum basilicum). It is a tender plant, and is used in cuisines worldwide.'
          'Basil is native to tropical regions from Central Africa to Southeast Asia. In temperate climates '
          'basil is treated as an annual plant, however, basil can be grown as a short-lived perennial or biennial in '
          'warmer horticultural zones with tropical or Mediterranean climates.',
      imageAsset: 'assets/herbal/genovese_basil.webp',
      imageUrl: [
  ...
  Herbal(
      name: 'Chervil',
      category: 'Herbal',
      detail: 'Chervil (Anthriscus cerefolium), '
          'is a delicate annual herb related to parsley. It was formerly called myrhis due to its volatile oil with an aroma similar '
          'to the resinous substance of myrrh. It is commonly used to season mild-flavoured dishes and is a constituent of the French herb mixture fines herbes.',
  ...
  Herbal(
      name: 'Chamomile',
      category: 'Herbal',
      detail: 'Chamomile (American English) or camomile is a,'
      ...
      imageAsset: 'assets/herbal/chamomile.webp',
      imageUrl: [
